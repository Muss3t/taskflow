...
export class UI {
    ...
    iniciarEventos() {
        ...
        this.listaTareas.addEventListener("click", (e) => this.manejarClickLista(e));
    ...
    filtrarTareas(e) {
        ...
        items.forEach((item) => {
            const descripcion = item.querySelector(".descripcion-text").textContent.toLowerCase();
    ...
    renderizar() {
        ...
        tareas.forEach((tarea) => {
            ...
            li.addEventListener("mouseover", () => {
                li.style.backgroundColor = tarea.estado === "completada" ? "#e2e8f0" : "#f0fdf4";
            });
